 ...
 *
 */
public class TaskStatusHistoryDetailsDto implements Serializable {
    ...
    public TaskStatusHistoryDetailsDto() {
	// Default Constructor
    }

    public TaskStatusHistoryDetailsDto(Long taskHistoryId, TaskStatus taskStatusId, Task taskId, Boolean isActive,
	...
	if (getClass() != obj.getClass())
	    return false;
	TaskStatusHistoryDetailsDto other = (TaskStatusHistoryDetailsDto) obj;
	if (createdBy == null) {
	...
	return "TaskStatusHistoryDetailsDto [taskHistoryId=" + taskHistoryId + ", taskStatusId=" + taskStatusId
