 ...
 *
 */
public class AssetPodConfigDto implements Serializable {
    ...
    public AssetPodConfigDto() {
	// Default Constructor
    }

    public AssetPodConfigDto(Long assetPodConfigId, Long siteAssetId, Long assetId, LocalDate podDate,
	    Long assetPodPriorityOrder, Boolean isActive, String createdBy, LocalDateTime createdOn,
	...
	if (getClass() != obj.getClass())
	    return false;
	AssetPodConfigDto other = (AssetPodConfigDto) obj;
	if (assetId == null) {
	...
	return "AssetPodConfigDto [assetPodConfigId=" + assetPodConfigId + ", siteAssetId=" + siteAssetId + ", assetId="
		+ assetId + ", podDate=" + podDate + ", assetPodPriorityOrder=" + assetPodPriorityOrder + ", isActive="
