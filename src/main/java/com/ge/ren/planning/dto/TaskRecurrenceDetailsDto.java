 ...
 *
 */
public class TaskRecurrenceDetailsDto implements Serializable {
    ...
    public TaskRecurrenceDetailsDto() {
	// Default Constructor
    }

    public TaskRecurrenceDetailsDto(Long taskRecurrenceId, Long recurrenceTypeId, Long taskId, String recurrenceType,
    ...
    /**
     * @param taskRecurrenceId
     *            the taskRecurrenceId to set
     */
    ...
    /**
     * @param recurrenceEndByDate
     *            the recurrenceEndByDate to set
     */
    ...
    /**
     * @param recurrenceEndByCount
     *            the recurrenceEndByCount to set
     */
	...
	if (getClass() != obj.getClass())
	    return false;
	TaskRecurrenceDetailsDto other = (TaskRecurrenceDetailsDto) obj;
	if (createdBy == null) {
	...
	return "TaskRecurrenceDetailsDto [taskRecurrenceId=" + taskRecurrenceId + ", taskId=" + taskId + ", recurrenceType=" + recurrenceType + ", recurrence="
		+ recurrence + ", recurrenceCycle=" + recurrenceCycle + ", recurrenceEndByDate=" + recurrenceEndByDate
