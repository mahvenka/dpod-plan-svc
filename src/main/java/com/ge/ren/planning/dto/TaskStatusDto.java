...
public class TaskStatusDto implements Serializable {
    ...
    public TaskStatusDto(Long taskStatusId, String taskStatusNameDefault, Boolean isActive, String createdBy,
	...
	return "TaskStatusDto [taskStatusId=" + taskStatusId + ", taskStatusNameDefault=" + taskStatusNameDefault
