...
public class TaskPriority implements Serializable {
    ...
    @Column(name = "task_priority_name_default")
    private String taskPriorityNameDefault;

    @Column(name = "task_priority_order")
    ...
    public TaskPriority(Long taskPriorityId, Long tenantId, String taskPriorityNameDefault, Integer taskPriorityOrder,
    ...
    /**
     * @param taskPriorityNameDefault the taskPriorityNameDefault to set
     */
    ...
    /**
     * @param taskPriorityOrder the taskPriorityOrder to set
     */
	...
	return "TaskPriority [taskPriorityId=" + taskPriorityId + ", tenantId=" + tenantId
